...
export async function POST(request: NextRequest) {
  ...
  if (contentType.includes('multipart/form-data')) {
    ...
    const { data: existing } = await supabase.from('budget_figures').select('id').limit(1)
  ...
  await supabase.from('budget_figures').delete().neq('id', '00000000-0000-0000-0000-000000000000')
